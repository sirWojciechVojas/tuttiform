	...
	<div class="panel template checkboxes" id="" data-attribute-type="multiple">
		<div class="panel-body mb-10">
            ...
            <div class="row template drop-down">
                <div class="col-md-9">
                    <div class="col-md-3">
                        <select class="select select2-hidden-accessible" name="drop_down.dc9588cf" data-width="30%" id="drop_down.dc9588cf.7" required="required" tabindex="-1" aria-hidden="true">
