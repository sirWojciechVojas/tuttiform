		...
		<div class="panel-body mb-10">
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <div class="col-md-1">
                        <input type="text" type="number" class="form-control" id="" name="" placeholder="Number" aria-hidden="true">
                    </div>
                    <div class="col-md-9">
                        <input type="text" type="text" class="form-control" id="" name="" placeholder="Custom Error Text" aria-hidden="true">
                    </div>
                </div>
            </div>
		</div>
				...
				<div class="options button checkboxes">
					<div class="checkbox mt-15 mb-15">
						<label>
                            ...
                            <div class="box box-orange box-example">
                                <div class="box-body">
                                    <select  id="example-1to10" data-id="example-1to10" name="rating" class="rating">
