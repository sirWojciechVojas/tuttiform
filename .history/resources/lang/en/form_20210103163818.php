		...
		<div class="panel-body mb-10">
            ...
            <div class="row template drop-down">
                <div class="col-md-6">
                    ...
                    <input type="text" type="number" class="form-control input-xlg" id="" name="" placeholder="Number" value="75">
                    <input type="text" type="text" class="form-control input-xlg" id="" name="" placeholder="Custom Error Text">
                </div>
            </div>
		</div>
		<div class="panel-footer panel-footer-bordered">
