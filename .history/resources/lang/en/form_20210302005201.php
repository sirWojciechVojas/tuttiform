		...
		<div class="panel-body mb-10">
            ...
            <div id="ResVal" class="row" style="display:none;">
                <div class="col-lg-10 col-lg-offset-1 col-xl-8 col-xl-offset-2">
                    <div class="col-md-2">
                        <select class="select select2-hidden-accessible" name="sel_type" data-width="100%" id="" required="required" tabindex="-1" aria-hidden="true">
                            <option value="0">Select at least</option>
                            <option value="1">Select at most</option>
                            <option value="2">Select exactly</option>
                        </select>
                    </div>
                    <div class="col-md-1">
			...
			<div class="heading-elements">
				...
				<div class="pull-right">
					<div class="heading-form">
                        <div class="form-group">
                            <label class="checkbox-inline checkbox-right checkbox-switchery switchery-sm">
                                <input type="checkbox" class="switchery question-resval" name="" id="">
                                Response Validation
                            </label>
							<label class="checkbox-inline checkbox-right checkbox-switchery switchery-sm">
								<input type="checkbox" class="switchery question-required" name="" id="" checked="checked">
		...
		<div class="col-md-12">
			<div class="form-group">
                ...
                <div class="options button checkboxes">
                    <li class="tile vcenter col-xs-12 col-sm-12 col-md-6 col-lg-4 p-1">
                        <div class="checkbox vcenter col-xs-10 col-sm-10 col-md-10">
                            <label>
                                <input type="checkbox" class="styled" name=""> <span class="option">Option 1</span>
                            </label>
                        </div>
                        <span class="glyphicon glyphicon-menu-hamburger col-sm-1 col-md-1" aria-hidden="true" style="visibility: hidden;"></span>
                        <div class="checkbox vcenter points-rating col-sm-1 col-md-1" style="visibility: hidden;"><span>?</span></div>
                    </li>
				</div>
			</div>
		</div>
