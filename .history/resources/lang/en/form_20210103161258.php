	...
	<div class="panel template checkboxes" id="" data-attribute-type="multiple">
		<div class="panel-body mb-10">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="drop_down.dc9588cf.7" class="label-xlg field-label"><span class="question">Co jest?</span> <span class="text-danger required">*</span></label>
                        <div class="options select">
                            <select class="select select2-hidden-accessible" name="drop_down.dc9588cf" data-width="100%" id="drop_down.dc9588cf.7" required="required" tabindex="-1" aria-hidden="true">
                            <option value="">Choose an Option</option><option value="Select at least">Select at least</option><option value="Select at most">Select at most</option><option value="Select exactly">Select exactly</option></select><span class="select2 select2-container select2-container--default select2-container--below select2-container--focus" dir="ltr" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-drop_downdc9588cf7-container"><span class="select2-selection__rendered" id="select2-drop_downdc9588cf7-container" title="Select at least">Select at least</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                        </div>
                    </div>
                </div>
            </div>
			...
			<div class="heading-elements">
				...
				<div class="pull-right">
					<div class="heading-form">
                        <div class="form-group">
                            <label class="checkbox-inline checkbox-right checkbox-switchery switchery-sm">
                                <input type="checkbox" class="switchery" name="" id="">
                                Response Validation
                            </label>
							<label class="checkbox-inline checkbox-right checkbox-switchery switchery-sm">
								<input type="checkbox" class="switchery question-required" name="" id="" checked="checked">
