		...
		<div class="panel-body mb-10">
            ...
            <div class="row template drop-down">
                <div class="col-md-6">
                    ...
                    <span>
                        <input type="text" type="number" class="form-control input-xlg" id="" name="" placeholder="Number" aria-hidden="true">
                    </span>
                    <input type="text" type="text" class="form-control input-xlg" id="" name="" placeholder="Custom Error Text" aria-hidden="true">
                </div>
            </div>
		</div>
		<div class="panel-footer panel-footer-bordered">
