            ...
            @else
                ...
                <div class="panel-body">
                    <form id="user-form" action="{{ ($view_type === 'form') ? route('forms.responses.store', $form->code) : "#" }}" method="{{ ($view_type === 'form') ? "post" : "get" }}" autocomplete="off">
                        ...
                        <div class="text-left mt-20" style="position:fixed; bottom:0;">
...
<div class="row walid vcenter">
    <div class="col-md-12 ">
        <div>Zaznaczono:<span>0</span></div>
        <div>Pozostało:<span>LIMIT</span></div>
        <div>Musisz zaznaczyć LIMIT utworów!</div>
    </div>
</div>
@endsection
