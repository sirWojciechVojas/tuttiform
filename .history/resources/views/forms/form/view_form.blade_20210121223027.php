                ...
                <div class="panel-body">
                    <form id="user-form" action="{{ ($view_type === 'form') ? route('forms.responses.store', $form->code) : "#" }}" method="{{ ($view_type === 'form') ? "post" : "get" }}" autocomplete="off">
                        ...
                        <div class="text-left mt-20">
                            <button id="submit" type="{{ ($view_type === 'form') ? 'submit' : 'button' }}" class="btn btn-primary disabled" data-loading-text="Please Wait..." data-complete-text="Submit Form">Submit Form</button>
                        </div>
                    </form>
                </div>
            @endif
...
<div class="row walid vcenter">
    <div class="col-md-7">
        ...
        <div>Pozostało: <span>170</span> utworów</div>
        <div>Musisz zaznaczyć <span>170</span> utworów!</div>
    </div>
</div>
@endsection
