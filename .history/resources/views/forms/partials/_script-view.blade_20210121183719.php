            ...
            template_divs.each(function (index) {
                ...
                if (field_attribute_type === 'single') {
                    ...
                    if (options_div.hasClass('button')) {
                        ...
                        options_div.find('div.tiles').empty();
                        options_div.append('<div>kkkk</div>');
                        console.log(options_div.find('.tiles').html());
                        var all_options='';
                        for(v=1;v<=10;v++){
                        ...
                        if (field_data['options'] !== null) {
                            ...
                            for (var i = 0; i < field_options.length; i++) {
                                ...
                                options_div.find('.tiles').append(button);
                                options_div.find('.tiles').append(star);
                            }
                        }
                        $('.rating').barrating({
