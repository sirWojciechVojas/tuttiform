                    ...
                    if (options_div.hasClass('button')) {
                        ...
                        if (field_data['options'] !== null) {
                            ...
                            for (var i = 0; i < field_options.length; i++) {
                                ...
                                nr = i+1;
                                if(button.find('span.option').css('white-space') == 'nowrap') var endi=(field_options[i].length>58) ? field_options[i]+'...': field_options[i];
                                else var endi = button.find('span.option').css('white-space');

                                button.find('span.option').text(nr+' - '+endi)
