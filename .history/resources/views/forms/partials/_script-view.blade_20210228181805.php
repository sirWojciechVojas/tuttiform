<script>
    $(function() {
        ...
        $('#exampleModal').on('show.bs.modal', function(){
            var tiles = $('div.tile div.checkbox div.checker > span.checked').closest('div.tile').removeClass('col-md-6').addClass('col-md-12').clone();
            $(this).find('.modal-body').html(tiles);
        });
