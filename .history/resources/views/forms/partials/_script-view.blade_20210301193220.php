<script>
    $(function() {
        ...
        $('#exampleModal').on('show.bs.modal', function(){
            ...
            var tiles = $('#user-form div.tile div.checkbox div.checker > span.checked').closest('div.tile').clone();
            var ile = tiles.length;
            tiles.each(function(index){
                $(this).find('.points-rating span').text(ile-index);
            });
            tiles.replaceWith(function() {
                return "<li>" + this.innerHTML + "</li>";
            });
            $(this).find('.modal-body .ui-sortable').html(tiles.removeClass('col-md-6 col-lg-4'));

            $('.modal-body .ui-sortable').sortable({
                items:'> .tile',
                ...
                stop: function( event, ui ) {
                    $(this).find('.points-rating span').each(function(index){
                        $(this).text(ile-index);
                        //alert(ile-index);
                    });
                }
