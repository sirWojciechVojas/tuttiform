    ...
    $(function() {
        ...
        $('#exampleModal').on('show.bs.modal', function(){
            ...
            tiles.each(function(index){
                $(this).find('.points-rating span').text(ile-index+' pkt').parent().css({'visibility': 'visible'}).prev().css({'visibility': 'visible'});
            });
            ...
            var orderedInputs = $('#sortable .checker span.checked input');
            $('#form-super button[type="button"].btn-primary').on('click', function(){
                $('#user-form .checker span.checked').each(function(index){
                    alert(orderedInputs.eq(index).val());
                    //$(this).val();
                    //alert($(this).html());
                    //$(this).html('');
                });
